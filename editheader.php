<?php
   ...
   $firstSetHeadStr="<a href=\"edit.php?set=$firstSet\">Oldest Set</a>";
   if(empty($firstSet)) $firstSetHeadStr="Oldest Set";
   
   $prevSetHeadStr="<a href=\"edit.php?set=$prevSet\">Previous Set</a>";
   if(empty($prevSet)) $prevSetHeadStr="Previous Set";
   
   $nextSetHeadStr="<a href=\"edit.php?set=$nextSet\">Next Set</a>";
   if(empty($nextSet)) $nextSetHeadStr="Next Set";
   
   $lastSetHeadStr="<a href=\"edit.php?set=$lastSet\">Most Recent Set</a>";
   ...
   $setTable->setHeaderContents(0,4,"<a href=\"edit.php\">Unprinted</a>");
